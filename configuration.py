...
parser.add_argument('-t','--task', help='Task Number', required=False, default=1)
...
parser.add_argument('-um','--unk_mask', help='mask out input token to UNK', required=False, default=False)
...
parser.add_argument('-useKB','--useKB', help='Put KB in the input or not', required=False, default=0)
